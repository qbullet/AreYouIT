    ...
    >
        <template>
            <div align="left">
                ...
                <b-container style="margin-top:0%">
                    <b-row>
                        <b-col>มีความกังวลกับการติด "F" : </b-col>
                        <b-col>
                            <b-form-group >
                                <b-form-radio-group
    ...
    methods: {
        async onSubmit(evt) {
            ...
            if(resp.state == 200){
                ...
                msg = "คุณเหมาะสมกับสาขาไอที ด้วยค่าความมั่นใจเท่ากับ " + resp.value
                style = "success"
            }else if(resp.state == 100){
                heading = "เป็นเรื่องที่น่าเศร้า"
                msg = "คุณไม่เหมาะกับสาขาไอที ด้วยค่าความมั่นใจเท่ากับ " + resp.value
                style = "error"
            }
